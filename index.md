...
<tbody><tr><td style='text-align:center'> emporia vue2 3 phase </td><td style='text-align:center'> <esp-web-install-button manifest='./emporia-vue2-3-phase-esp32/manifest.json'><button slot='activate'>Install via Web</button></esp-web-install-button> </td><td style='text-align:center'> <a href='emporia-vue2-3-phase-esp32/emporia-vue2-3-phase-esp32.bin'><button>Download Firmware</button></a> </td><td style='text-align:center'><a href='https://github.com/cpyarger/esphome-templates/blob/main/emporia-vue2-3-phase.yaml'>YAML</a></td></tr>
<tr><td style='text-align:center'> emporia vue2 </td><td style='text-align:center'> <esp-web-install-button manifest='./emporia-vue2-esp32/manifest.json'><button slot='activate'>Install via Web</button></esp-web-install-button> </td><td style='text-align:center'> <a href='emporia-vue2-esp32/emporia-vue2-esp32.bin'><button>Download Firmware</button></a> </td><td style='text-align:center'><a href='https://github.com/cpyarger/esphome-templates/blob/main/emporia-vue2.yaml'>YAML</a></td></tr>
